import {
  ...
  Vector2,
  Vector3 as Vector32
} from "./chunk-DFJSAHLT.js";
import {
  __publicField
} from "./chunk-MVSJFUC4.js";

// ../../Library/PackageCache/com.needle.engine@2.7.3-pre/package~/node_modules/three-mesh-ui/build/three-mesh-ui.module.js
...
__webpack_require__.d(__webpack_exports__, {
  "g1": () => AlignItems_namespaceObject,
  "gO": () => Block,
  "km": () => ContentDirection_namespaceObject,
  "zV": () => core_FontLibrary,
  "ol": () => InlineBlock,
  "uM": () => JustifyContent_namespaceObject,
  "N1": () => Keyboard,
  "xv": () => Text,
  "PH": () => TextAlign_namespaceObject,
  "UH": () => Whitespace_namespaceObject,
  "ZP": () => three_mesh_ui,
  "Vx": () => update
});
...
function _distanceToNextBreak(inlines, currentIdx, options, accu) {
  ...
  return _distanceToNextBreak(inlines, currentIdx + 1, options, accu + xadvance + options.LETTERSPACING + xoffset + kerning);
}
...
var Block = class extends mix.withBase(external_three_namespaceObject.Object3D)(BoxComponent, InlineManager, MaterialManager, MeshUIComponent) {
  constructor(options) {
    super(options);
    this.isBlock = true;
...
var MSDFGlyph = class extends external_three_namespaceObject.PlaneBufferGeometry {
...
var Text = class extends mix.withBase(external_three_namespaceObject.Object3D)(InlineComponent, TextManager, MaterialManager, MeshUIComponent) {
  constructor(options) {
    super(options);
    this.isText = true;
    this.set(options);
...
var InlineBlock = class extends mix.withBase(external_three_namespaceObject.Object3D)(InlineComponent, BoxComponent, InlineManager, MaterialManager, MeshUIComponent) {
  constructor(options) {
    super(options);
...
// dep:three-mesh-ui
var three_mesh_ui_default = __webpack_exports__default;
export {
  ...
  three_mesh_ui_default as default,
