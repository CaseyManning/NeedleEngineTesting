...
// ../../Library/PackageCache/com.needle.engine@2.7.3-pre/package~/node_modules/three/examples/jsm/loaders/GLTFLoader.js
...
var GLTFAnimationPointerExtension = class {
  constructor(parser) {
    __publicField(this, "ANIMATION_TARGET_TYPE", {
      node: "node",
      material: "material",
      camera: "camera",
      light: "light"
    });
    __publicField(this, "_animationPointerDebug", false);
    __publicField(this, "_havePatchedPropertyBindings", false);
    this.parser = parser;
  ...
  _patchPropertyBindingFindNode() {
    ...
    PropertyBinding.findNode = (node, path) => {
      if (path.startsWith(".materials.")) {
        ...
        node.traverse((x) => {
          var _a, _b;
          if (res !== null || x.type !== "Mesh")
            return;
          if (((_a = x["material"]) == null ? void 0 : _a.uuid) === uuid || ((_b = x["material"]) == null ? void 0 : _b.name) === uuid) {
            res = x["material"];
            if (this._animationPointerDebug)
  ...
  createAnimationTracks(node, inputAccessor, outputAccessor, sampler, target) {
    ...
    parts[2] = (_a = node.name) != null ? _a : node.uuid;
...
//# sourceMappingURL=chunk-ZSCTBWHW.js.map
